...
exports.getFragmentForService = function(serviceType) {
  switch(serviceType) {
    case ('cloudant'): return '../fragments/_cloudant.ejs';
    case ('redis'): return '../fragments/_redis.ejs';
  }
};

exports.getCloudType = function(serviceType) {
  switch(serviceType) {
