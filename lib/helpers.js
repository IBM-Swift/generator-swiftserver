  ...
  switch (typeof(value)) {
    ...
    case 'object':
      ...
      if (Array.isArray(value)) {
        return value.map((element) => { exports.convertJSDefaultValueToSwift(element); });
      } else {
        return Object.keys(value).reduce((memo, key) => { memo[key] = exports.convertJSDefaultValueToSwift(value[key]) }, {});
      }
