...
exports.generatePackageSwift = function(config, addTargetDependency) {
  var targets = !addTargetDependency ? '' : `targets: [
  ...
  if (config.store === 'cloudant') {
    store = '.Package(url: "https://github.com/IBM-Swift/GeneratedSwiftServer-CloudantStore.git", majorVersion: 0),';
  }
  return `
