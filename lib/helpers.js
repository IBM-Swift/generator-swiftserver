...
exports.generatePackageSwift = function(config) {
  ...
  if (config.logger === 'helium') {
    logger = '.Package(url: "https://github.com/IBM-Swift/HeliumLogger.git", majorVersion: 1),';
  }
  //Hard coded as we don't have the optional dependencies implemented
  var store = '.Package(url: "https://github.com/IBM-Swift/GeneratedSwiftServer-CloudantStore.git", majorVersion: 0, minor: 1),';
  //TODO: re-implement this when we have added optional dependencies on the stores
  /*if (config.store === 'cloudant') {
    store = '.Package(url: "https://github.com/IBM-Swift/GeneratedSwiftServer-CloudantStore.git", majorVersion: 0, minor: 1),';
  }*/
  return `
