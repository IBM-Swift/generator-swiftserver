...
exports.optionalProperties = function (propertyInfos, helpers, model) {
  var properties = ''
  // Optional properties
...
exports.propertyMapping = function (propertyInfos) {
  propertyInfos.map(function (info) {
    return (info.name).join(', ')
  })
}

exports.eachInMap = function (object, map, block) {
