...
exports.generatePackageSwift = function(config) {
  ...
  var store = '.Package(url: "https://github.com/IBM-Swift/GeneratedSwiftServer-CloudantStore.git", majorVersion: 0, minor: 2),';
  //TODO: re-implement this when we have added optional dependencies on the stores
  /*if (config.store === 'cloudant') {
    store = '.Package(url: "https://github.com/IBM-Swift/GeneratedSwiftServer-CloudantStore.git", majorVersion: 0, minor: 2),';
  }*/
  return `
