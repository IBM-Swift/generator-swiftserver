...
This generator and the Yeoman library runs on Node.js and generates a Swift 4.2.2 application.
...
## Prerequisites
To use this module, you will need Node.js and Swift 4.2.2 installed on your Linux or macOS system. You can get Node.js from https://nodejs.org and Swift 4.2.2 from https://swift.org/download.
