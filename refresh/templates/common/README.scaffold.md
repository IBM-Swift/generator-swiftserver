...
A quick start guide to IBM Alert Notification Service on Bluemix can be found [here].(https://www.ibm.com/blogs/bluemix/2015/12/quick-start-guide-to-alert-notification-service/)
<%   } -%>
<%   if (autoscale) { -%>
#### Auto-scaling
